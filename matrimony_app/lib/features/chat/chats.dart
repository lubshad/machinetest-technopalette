...
class _ChatPageState extends State<ChatPage>
  ...
  void initiateChat() async {
    ...
    await AgoraRTMService.i.signIn(
      userid: CommonController.i.profileDetails!.userId.toString(),
      avatarUrl: CommonController.i.profileDetails!.photo ?? "",
      name: CommonController.i.profileDetails!.fullName,
    );
  }
